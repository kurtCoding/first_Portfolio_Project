...
export default function Hoohah() {
    ...
    return (
        <div>
            ...
            <p><span>5</span>.  <strong>Extraterrestrial Influence on Humanity</strong> and <strong>New World Order and Mass Hysteria</strong>:     In the episode "Get Schwifty," Earth faces an existential threat when a giant alien head (referred to as a Cromulon) appears in the sky, demanding to be entertained with a catchy musical performance. Rick and Morty are thrust into the task of creating and performing a song to appease the Cromulon, who uses his powers to enforce participation. Meanwhile, the sudden appearance of the alien head causes widespread panic and the rise of a new religion, the Church of the Headism, which worships the alien head as a deity.</p> <br/>
             <p>This episode plays on the conspiracy theory that advanced alien civilizations have a direct influence on human affairs. In this case, the Cromulon demands Earth's submission through entertainment, suggesting that humanity is at the mercy of powerful extraterrestrial beings.</p> <br/> 
